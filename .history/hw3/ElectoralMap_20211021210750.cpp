            ...
            if(temp_party != party::none && store_all[temp_party].size() > 0){ //three party constituent
              //  std::cout << "!!!" << std::endl;
               ...
               std::cout << "district_id "<< each_district->second->get_id() << std::endl;
                candidate_[store_all[temp_party][rand_candidate]]->plus_vote(*each_district->second, vote);
                ...
                if(max_local != party::none){
                   ...
                   std::cout << "district_id "<< each_district->second->get_id() << std::endl;
                    candidate_[store_all[max_local][rand_candidate]]->plus_vote(*each_district->second, vote);
                }else{
                  //  std::cout << "^^^^^" << std::endl;
                    int rand_candidate = rand()% candidate_.size();
                   // std::cout <<"rand3:  "<< store_all[temp_party][rand_candidate] << std::endl;
                   std::cout << "district_id "<< each_district->second->get_id() << std::endl ;
                    candidate_[rand_candidate]->plus_vote(*each_district->second, vote);
                }
