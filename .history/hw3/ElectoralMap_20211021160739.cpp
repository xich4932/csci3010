...
void ask_party(std::string &name){

}

Election::register_candidate(party party_name, std::string name){
    Candidate * insert_one = new Candidate(ids + 1, party_name ,name);
    candidate_.insert(std::pair<int, Candidate*>(ids+1, insert_one));
}
