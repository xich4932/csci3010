...
void RepresentativeElection::voting(){
    std::map<party, int> vote_map;
    vote_map.insert(std::pair<party,ine>(party::one,0)); 
    vote_map.insert(std::pair<party,ine>(party::two,0)); 
    vote_map.insert(std::pair<party,ine>(party::three,0)); 
    for(int i =0; i < num_district; i++){
