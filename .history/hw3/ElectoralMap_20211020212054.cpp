...
void RepresentativeElection::voting(){
    ...
    map_representative.insert(std::pair<party,ine>(party::one,0)); 
    map_representative.insert(std::pair<party,ine>(party::two,0)); 
    map_representative.insert(std::pair<party,ine>(party::three,0)); 
